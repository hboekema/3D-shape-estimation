...
#exp_dir = "../experiments/xfull_rot_elbow_result_2019-11-22_10:57:13/"
#exp_dir = "../experiments/full_rot_elbow_result_2019-11-22_15:29:15/"
#exp_dir = "../experiments/full_rot_elbow_result_2019-11-22_16:13:49/"
#exp_dir = "/data/cvfs/hjhb2/projects/mesh_rendering/experiments/2019-11-23_10:14:08/"
exp_dir = "/data/cvfs/hjhb2/projects/mesh_rendering/experiments/2019-11-23_10:23:59/"
model = exp_dir + "models/" + "model.149-53.59.hdf5"


#model = model_dir + "model.99-87.52.hdf5"
#model = model_dir + "model.09-61.56.hdf5"
#model = model_dir + "model.09-54.15.hdf5"
...
epoch_pred_cb_control = OptLearnerPredOnEpochEnd(logs_dir, smpl, train_inputs=X_cb, train_silh=silh_cb, pred_path=control_dir, period=1, visualise=False)
...
#        print("------------------------------------")
#        num_samples = 3
#        print("GT SMPL: " + str(x_test[1][:num_samples, 57:60]))
#        print("Parameters: " + str(y_pred[0][:num_samples, 57:60]))
#        print("Gradients: " + str(y_pred[5][:num_samples, 57:60]))
#        print("Delta_d: " + str(y_pred[6][:num_samples, 57:60]))
#        print("Delta_d_hat: " + str(y_pred[7][:num_samples, 57:60]))
#        print("Delta_d_hat_NOGRAD: " + str(y_pred[8][:num_samples, 57:60]))

        epoch_pred_cb.on_epoch_end(epoch=i)

        for emb_layer, param_num in trainable_layers.items():
	    emb_weights = emb_layer.get_weights()
            emb_weights += np.array(y_pred[7][:, param_num]).reshape((data_samples, 1))

...
info = {'model_weights_path': "../experiments/2019-11-19_14:02:52/models/model.49-116.19.hdf5"}
#info = {'model_weights_path': "../experiments/2019-11-16_10:57:46/models/model.499-0.01.hdf5"}
#info = {'model_weights_path': "../experiments/one_param_result//models/model.199-0.15.hdf5"}
...
exp_dir = info["model_weights_path"][:34] + "/"
...
def learned_optimizer(epochs=50, lr=learning_rate):

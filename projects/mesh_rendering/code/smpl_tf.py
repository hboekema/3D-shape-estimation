...
# def smpl_model_batched(model_path, parameter_batch):
#     """ Wrapper for applying the 'smpl_model' function in a 'batched' manner """
#     parameter_batch = tf.cast(parameter_batch, tf.float64)
#
#     vertices_list = []
#     for parameters in parameter_batch:
#         vertices, _ = smpl_model(model_path, parameters[72:82], parameters[:72], parameters[82:85])
#         vertices_list.append(vertices)
#
#     return tf.convert_to_tensor(vertices_list)

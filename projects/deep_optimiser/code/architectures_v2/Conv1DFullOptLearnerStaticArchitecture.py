...
def Conv1DFullOptLearnerStaticArchitecture(param_trainable, init_wrapper, smpl_params, input_info, faces, emb_size=1000, input_type="3D_POINTS"):
...
#            3365, 4606, 4588, 4671, 6877, 1799, 5262, 3479, 1187, 1102, 1120, 6740]
    # more vertices for shape estimation
    subsample_n = 10
    vertex_list = [i*10 for i in range(6890/subsample_n)]

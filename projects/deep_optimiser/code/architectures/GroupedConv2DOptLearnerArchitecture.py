...
def GroupedConv2DOptLearnerArchitecture(param_trainable, init_wrapper, smpl_params, input_info, faces, PARAM_2D_TRAINABLE, emb_size=1000, input_type="3D_POINTS", groups=[], DROPOUT=0.0):
    ...
    gt_normals_TRUE = get_mesh_normals(gt_pc, face_array, layer_name="gt_cross_product")
    ...
    #return [optlearner_input, gt_params, gt_pc, gt_silh], [optlearner_params, false_loss_delta_d, optlearner_pc, false_loss_pc, false_loss_delta_d_hat, false_sin_loss_delta_d_hat,  false_update_loss, delta_d, delta_d_hat, diff_normals2_mse, per_param_mse, gt_normals_LOSS, opt_normals]    # gt_normals are not the GT normals anymore - they are predictions from the Conv2D network - @TODO: replace gt_normals_LOSS with gt_normals_TRUE and also append gt_normals_LOSS as an additional output
    return [optlearner_input, gt_params, gt_pc, gt_silh], [optlearner_params, false_loss_delta_d, optlearner_pc, false_loss_pc, false_loss_delta_d_hat, false_sin_loss_delta_d_hat,  false_update_loss, delta_d, delta_d_hat, diff_normals2_mse, per_param_mse, gt_normals_TRUE, opt_normals, gt_normals_LOSS]

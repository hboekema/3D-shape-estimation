...
def Conv1DFullOptLearnerStaticArchitecture(param_trainable, init_wrapper, smpl_params, input_info, faces, emb_size=1000):
    ...
    optlearner_architecture = Reshape((optlearner_architecture.shape[1], 1))(optlearner_architecture)
